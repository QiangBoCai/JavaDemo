...
public class HttpClientDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        HttpClientRequestContext httpClientRequestContext = httpUriRequestConverter.convert(request, task.getSite(), proxy);
          
        logger.debug("httpClientRequestContext init end");
        Page page = Page.fail();
        try {
        	//4.httpClient执行，返回HttpResponse
            httpResponse = httpClient.execute(httpClientRequestContext.getHttpUriRequest(), httpClientRequestContext.getHttpClientContext());
